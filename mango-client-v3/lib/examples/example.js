...
function examplePerp() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // load group & market
        const perpMarketConfig = src_1.getMarketByBaseSymbolAndKind(groupConfig, 'BTC', 'perp');
        ...
        39000, 0.0001, { orderType: 'postOnlySlide', expiryTimestamp: src_1.getUnixTs() + 5 }); // or 'ioc' or 'postOnly'
