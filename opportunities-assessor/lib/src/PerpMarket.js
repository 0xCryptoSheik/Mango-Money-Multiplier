...
class PerpMarket {
    ...
    get minOrderSize() {
        if (this._minOrderSize === undefined) {
            this._minOrderSize = this.baseLotsToNumber(src_1.ONE_BN);
        }
        return this._minOrderSize;
    }
    get tickSize() {
        if (this._tickSize === undefined) {
            this._tickSize = this.priceLotsToNumber(src_1.ONE_BN);
        }
    ...
    getCurrentFundingRate(group, cache, marketIndex, bids, asks) {
        ...
        if (bid !== undefined && ask !== undefined) {
            ...
            diff = src_1.clamp(bookPrice / indexPrice - 1, MIN_FUNDING, MAX_FUNDING);
        }
    ...
    loadEventQueue(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const parsed = src_1.PerpEventQueueLayout.decode(acc === null || acc === void 0 ? void 0 : acc.data);
            return new src_1.PerpEventQueue(parsed);
        });
    }
    ...
    loadBids(connection, includeExpired = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new src_1.BookSide(this.bids, this, src_1.BookSideLayout.decode(acc === null || acc === void 0 ? void 0 : acc.data), includeExpired);
        });
    }
    loadAsks(connection, includeExpired = false) {
        return __awaiter(this, void 0, void 0, function* () {
            const acc = yield connection.getAccountInfo(this.asks);
            return new src_1.BookSide(this.asks, this, src_1.BookSideLayout.decode(acc === null || acc === void 0 ? void 0 : acc.data), includeExpired);
        });
    }
    ...
    toPrettyString(group, perpMarketConfig) {
        ...
        const lines = [
            ...
            `feesAccrued: ${src_1.nativeToUi(this.feesAccrued.toNumber(), 6).toFixed(6)}`,
