...
class MangoAccount {
    ...
    loadSpotOrdersForMarket(connection, market, marketIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            const [bidsInfo, asksInfo] = yield src_1.getMultipleAccounts(connection, [
                market.bidsAddress,
                market.asksAddress,
            ]);
    ...
    loadOpenOrders(connection, serumDexPk) {
        return __awaiter(this, void 0, void 0, function* () {
            const accounts = yield src_1.getMultipleAccounts(connection, this.spotOpenOrders.filter((pk) => !pk.equals(utils_1.zeroKey)));
    ...
    loadAdvancedOrders(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const decoded = src_1.AdvancedOrdersLayout.decode(acc === null || acc === void 0 ? void 0 : acc.data);
    ...
    getPerpOpenOrders() {
        ...
        for (let i = 0; i < this.orders.length; i++) {
            ...
            perpOpenOrders.push({
                ...
                price: src_1.getPriceFromKey(this.orders[i]),
