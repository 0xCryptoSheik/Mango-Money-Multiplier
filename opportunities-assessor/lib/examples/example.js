    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        while (true) {
            ...
            for (const m in markets) {
                ...
                const rate = (yield perpMarket.getCurrentFundingRate(mangoGroup, cache, perpMarketConfig.marketIndex, bids, asks)) * 24 * 365 * 100 * 2;
                // @ts-ignore
            ...
            fs.writeFileSync('../intermediaryObj.json', JSON.stringify(rates));
            /*
              // L2 orderbook data
